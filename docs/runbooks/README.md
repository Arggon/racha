...
Operational runbooks for racha: step-by-step procedures for incidents, maintenance, and releases, written so an on-call engineer (human or agent) can execute them without tribal knowledge.
